                        ...
                        <div class="row">
                            ...
                            <div class="col-md-5">
                                <div class=" mx-auto mb-0">
                                    <img src="../assets/images/photos/main-1.png"
                            ...
                            <div class="tab-menu-heading ">
                                <div class="tabs-menu1  mx-auto pb-5">
                                    <ul class="nav ">
                                        ...
                                        <li><a href="#tab-61" data-bs-toggle="tab" class=" fw-bold">E-Attendence</a>
                                        </li>
                                        ...
                                        <div class="card-body">
                                            <div class="d-flex team-section-2">
                                                ...
                                                <div class="ms-lg-5 ms-xs-2 text-white card-day ">
                                                    <h2 class="font-weight-bold dark-grey-text mt-2 pb-5 ">Attendence
                                                    </h2>
                                                    <i class="fa fa-quote-left pe-3"></i>Lorem ipsum dolor sit amet,
                                                    consectetur adipisicing elit. Quod eos id officiis hic tenetur quae
                                                    quaerat ad velit ab hic tenetur.</p>
                                ...
                                <div class="item-card-desc">
                                    <div class="card text-center overflow-hidden">
                                        ...
                                        <div class="item-card-text">
                                            <h4 class="mb-0"><i
                                                    class="fa fa-map-marker text-white me-1 fs-3"></i><span
                                ...
                                <div class="row">
                                    <div class="col-xl-8 col-md-12 d-block mx-auto">
                                        <div class="testimonia">
                                            ...
                                            <p><i class="fa fa-quote-left"></i> Neque porro quisquam est, qui dolorem
                                                ipsum
